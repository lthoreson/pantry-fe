...
@Component({
  ...
  styleUrls: ['./add-pantry.component.css']
})
export class AddPantryComponent implements OnDestroy {
  public modifiedPantry: Pantry = new Pantry(null, '', this.account.getAccountInfo())
